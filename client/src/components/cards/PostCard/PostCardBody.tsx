...
const PostCardBody = ({
  ...
  return (
    <CardBody className={`pt-0 flex flex-col gap-1 max-md:px-1 md:px-2 lg:px-3 ${isGroupPost && "pb-2"}`}>
      ...
      <p className="text-light-text line-clamp-2 text-xs lg:text-small 2xl:text-sm ">{description}</p>
      <p className="text-light-text text-small lg:text-sm 2xl:text-base font-semibold">${price}</p>
