...
const user_person_DTO_1 = require("../../infraestructure/controller/dto/user.person.DTO"); // DTO para datos de usuarios personales.
const user_business_DTO_1 = require("../../infraestructure/controller/dto/user.business.DTO"); // DTO para datos de usuarios empresariales.
