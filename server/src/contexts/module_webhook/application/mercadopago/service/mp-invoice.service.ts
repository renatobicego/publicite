...
import Invoice from 'src/contexts/module_webhook/domain/mercadopago/entity/invoice.entity';
import { MercadoPagoInvoiceRepositoryInterface } from 'src/contexts/module_webhook/domain/mercadopago/repository/mp-invoice.respository.interface';
