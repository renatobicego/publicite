...
import { createPersonalUser, PersonalAccountTestRequest } from "../../../../test/functions_unit_testing/user/create.user";
...
import { createGroupMagazine, createSection } from "../../../../test/functions_unit_testing/user/create.magazine";
