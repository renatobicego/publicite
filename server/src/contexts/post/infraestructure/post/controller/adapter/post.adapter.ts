...
import {
  ...
  PostServiceRequest,
  PostPetitionRequest,
} from 'src/contexts/post/application/post/dto/HTTP-REQUEST/post.request';
import { PostUpdateRequest } from 'src/contexts/post/application/post/dto/HTTP-REQUEST/post.update.request';
import { PostResponse } from 'src/contexts/post/application/post/dto/HTTP-RESPONSE/post.response';
