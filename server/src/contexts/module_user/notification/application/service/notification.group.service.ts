...
import { eventsThatMakeNotificationActionsInactive_GROUP, GROUP_NOTIFICATION_send_group } from "../../domain/allowed-events/allowed.events.notifications";
...
export class NotificationGroupService implements NotificationGroupServiceInterface {
